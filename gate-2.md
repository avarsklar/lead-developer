...
Three skills. They need Gate 1 underneath them first.
...
Turns each must-not-break flow you care about (*log in, list an item, buy, pay…*) into a check that's been proven to go **red** when it breaks. You watch it catch a break made on purpose, once. After that it runs by itself on every change. *"The buy button charges a card"* stops being something you click through by hand and hope.

## [`/go-live-check`](skill-go-live-check.html) — the launch-readiness audit

A blunt **go / no-go** before you let strangers and real money in. It sets up your safety nets, then makes each one fail on purpose so you see it catch the failure. Re-run it every few months, because monitors quietly rot.

## [`/emergency-plan`](skill-emergency-plan.html) — the 2 a.m. plan

A one-page card you keep on your phone for the night something breaks: *is it just me or everyone? how do I get back to working? what do I tell my users? who do I call?* Then, in the same sitting if you can (bookable for later if not), a way back you've watched work and an alarm wired to your phone. The plan exists before the panic does. And your 2 a.m. AI gets standing, written orders: read and report on the tested path, don't improvise fixes.

That's Gate 2 — strangers and real money can arrive, and if something breaks, you'll know before they tell you.
